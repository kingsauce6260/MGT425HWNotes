Chapter 5 Hands-on
#Includes forecasting, regression model, lift chart, confusion matrix
Read Toyota Data File
...
Run Regression Model on Validation Dataset

# predictions
pred_v <- predict(reg, newdata = toyota.corolla.df[validation,-c(1,2,8,11)])

Evaluate Gain in Validation Model
